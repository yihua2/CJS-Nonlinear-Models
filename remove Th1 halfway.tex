...
% In particular, optimality in Loewner ordering is sufficient to optimality in any traditional convex information-based criteria, including but not restricted to A-, D- and E-optimality. With this complete class, we can conduct numerical search or mathematical derivation of optimal design $\tilde{\xi}$.
